#!/usr/bin/env python3
"""
Flight price tracker: SYD → MCY (Sydney NSW → Sunshine Coast QLD)
...
SEARCH_QUERIES = [
    ...
    f"Qantas flights Sydney NSW Sunshine Coast QLD 26 September 2026 return October 3 2026 price",
    f"cheapest flights Sydney Airport to Sunshine Coast Airport 26 September 3 October 2026",
]
